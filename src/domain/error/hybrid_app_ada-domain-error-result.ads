pragma Ada_2022;
--  =========================================================================
--  Hybrid_App_Ada.Domain.Error.Result - Generic Result monad for error handling
--  =========================================================================
...
--    - Uses Hybrid_App_Ada.Domain.Error.Error_Type for all errors
...
--
--    package String_Result is new Hybrid_App_Ada.Domain.Error.Result.Generic_Result
--      (T => String);
--
...
--
--  See Also:
--    Hybrid_App_Ada.Domain.Error - Error types used by this monad
--  =========================================================================

package Hybrid_App_Ada.Domain.Error.Result
  with Preelaborate
is
...
end Hybrid_App_Ada.Domain.Error.Result;
