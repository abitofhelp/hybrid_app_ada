pragma Ada_2022;
--  =========================================================================
--  Hybrid_App_Ada.Domain.Error - Error handling types and utilities
--  =========================================================================
...
--    - Used with Hybrid_App_Ada.Domain.Error.Result monad for functional error handling
--    - All errors use bounded strings (no heap allocation)
--
--  Usage:
--    with Hybrid_App_Ada.Domain.Error;           -- Gets error types
--    with Hybrid_App_Ada.Domain.Error.Result;    -- Gets Result[T] monad
--
--    use Hybrid_App_Ada.Domain.Error;  -- Makes Error_Kind, Error_Type visible
--
--  Design Pattern:
--    Hybrid_App_Ada.Domain error types as building blocks for Result monad:
...
--
--  See Also:
--    Hybrid_App_Ada.Domain.Error.Result - Generic Result monad using these error types
--  =========================================================================

with Ada.Strings.Bounded;

package Hybrid_App_Ada.Domain.Error
  with Preelaborate
is
   ...
   type Error_Kind is
     (Validation_Error,  --  Hybrid_App_Ada.Domain validation failures (invalid input)
...
end Hybrid_App_Ada.Domain.Error;
