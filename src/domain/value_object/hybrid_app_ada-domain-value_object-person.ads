pragma Ada_2022;
--  =========================================================================
--  Hybrid_App_Ada.Domain.Value_Object.Person - Person value object for the greeter domain
--  =========================================================================
...
--    Hybrid_App_Ada.Domain provides data (Get_Name), Hybrid_App_Ada.Application formats output.
--
--  Usage:
--    Result := Create ("Alice");
...
--
--  See Also:
--    Hybrid_App_Ada.Domain.Error.Result - Result type for error handling
--  =========================================================================

with Ada.Strings.Bounded;
with Hybrid_App_Ada.Domain.Error.Result;

package Hybrid_App_Ada.Domain.Value_Object.Person
  with Preelaborate
is
   ...
   package Person_Result is new
     Hybrid_App_Ada.Domain.Error.Result.Generic_Result (T => Person);
...
end Hybrid_App_Ada.Domain.Value_Object.Person;
