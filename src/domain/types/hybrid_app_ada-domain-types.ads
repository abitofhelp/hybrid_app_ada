pragma Ada_2022;
--  =========================================================================
--  Hybrid_App_Ada.Domain.Types - Parent package for domain utility types
--  =========================================================================
...
--
--  Contents:
--    Hybrid_App_Ada.Domain.Types.Option - Option/Maybe monad for optional values
--
--  See Also:
--    Hybrid_App_Ada.Domain.Value_Object - Domain-specific value objects
--    Hybrid_App_Ada.Domain.Error.Result - Result monad for error handling
--  =========================================================================

package Hybrid_App_Ada.Domain.Types
  with Pure
is

end Hybrid_App_Ada.Domain.Types;
