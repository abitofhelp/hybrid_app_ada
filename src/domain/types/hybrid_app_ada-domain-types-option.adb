pragma Ada_2022;
--  =========================================================================
--  Hybrid_App_Ada.Domain.Types.Option - Implementation of Option monad
--  =========================================================================
...
package body Hybrid_App_Ada.Domain.Types.Option is
   ...
   package body Generic_Option is
      ...
      function Or_Else (Primary : Option; Alternative : Option) return Option is
      begin
