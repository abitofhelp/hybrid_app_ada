pragma Ada_2022;
--  =========================================================================
--  Hybrid_App_Ada.Domain.Types.Option - Generic Option/Maybe monad
--  =========================================================================
...
--
--  Usage:
--    with Hybrid_App_Ada.Domain.Types.Option;
--
--    package String_Option is new Hybrid_App_Ada.Domain.Types.Option (T => String);
--
...
--
--  See Also:
--    Hybrid_App_Ada.Domain.Error.Result - For computations that can fail with error
--  =========================================================================

package Hybrid_App_Ada.Domain.Types.Option
  with Preelaborate
is
...
end Hybrid_App_Ada.Domain.Types.Option;
