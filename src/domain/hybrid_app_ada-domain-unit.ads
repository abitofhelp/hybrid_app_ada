pragma Ada_2022;
--  =========================================================================
--  Hybrid_App_Ada.Domain.Unit - Unit type for Result with no meaningful value
--  =========================================================================
...
--    - Located in Hybrid_App_Ada.Domain so ANY layer can use Result[Unit]
--
--  Usage:
...
--
--  See Also:
--    Hybrid_App_Ada.Domain.Error.Result - Generic Result monad
--  =========================================================================

package Hybrid_App_Ada.Domain.Unit
  with Pure
is
...
end Hybrid_App_Ada.Domain.Unit;
