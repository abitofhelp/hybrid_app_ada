pragma Ada_2022;
--  =========================================================================
--  Hybrid_App_Ada.Bootstrap.CLI - Implementation of CLI bootstrap
--  =========================================================================
...
with Hybrid_App_Ada.Presentation.Adapter.CLI.Command.Greet;

package body Hybrid_App_Ada.Bootstrap.CLI is
   ...
   function Run return Integer is
      ...
      --  =====================================================================
      --  Step 1: Instantiate Writer Port with Hybrid_App_Ada.Infrastructure implementation
      --  =====================================================================

      --  DEPENDENCY INVERSION in action:
      --  - Hybrid_App_Ada.Application.Port.Outbound.Writer defines the interface (port)
      --  - Hybrid_App_Ada.Infrastructure.Adapter.Console_Writer provides implementation
      ...
      package Greet_UseCase_Instance is new
        Hybrid_App_Ada.Application.Usecase.Greet
      ...
      --  Wire the Hybrid_App_Ada.Presentation layer to the Hybrid_App_Ada.Application layer.
      ...
      package Greet_Command_Instance is new
        Hybrid_App_Ada.Presentation.Adapter.CLI.Command.Greet
   ...
   begin
      ...
      --  6. Use_Case calls Hybrid_App_Ada.Domain.Value_Object.Person.Create("Alice")
      ...
      --      Writer -> Port -> Use_Case -> Command -> Hybrid_App_Ada.Bootstrap
      --  12. Hybrid_App_Ada.Bootstrap returns exit code to Main
