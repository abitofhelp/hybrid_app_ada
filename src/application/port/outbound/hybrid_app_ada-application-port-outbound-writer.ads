pragma Ada_2022;
--  =========================================================================
--  Hybrid_App_Ada.Application.Port.Outbound.Writer - Output port for writing operations
--  =========================================================================
...
--
--  Architecture Notes:
--    - Hybrid_App_Ada.Application layer defines the interface it NEEDS
--    - Hybrid_App_Ada.Infrastructure layer CONFORMS to this interface
--    - This breaks the dependency: Hybrid_App_Ada.Infrastructure ->
--      Hybrid_App_Ada.Application (not Hybrid_App_Ada.Application -> Hybrid_App_Ada.Infrastructure)
--    - STATIC DISPATCH via generics - resolved at compile time
--
--  Generic Parameter Flow:
--    1. Hybrid_App_Ada.Infrastructure implements Write function matching signature
--    2. Hybrid_App_Ada.Bootstrap instantiates generic with Hybrid_App_Ada.Infrastructure's Write
--    3. Use case receives instantiated port, calls Write without knowing impl
--    4. Zero runtime overhead - compile-time resolution
--
--  See Also:
--    Hybrid_App_Ada.Domain.Error.Result - Result type definition
--    Hybrid_App_Ada.Domain.Unit - Unit type for void returns
--    Hybrid_App_Ada.Infrastructure.Adapter.Console_Writer - Example
--    implementation of this port

with Hybrid_App_Ada.Domain.Error.Result;
with Hybrid_App_Ada.Domain.Unit;

package Hybrid_App_Ada.Application.Port.Outbound.Writer
  with Preelaborate
is

   --  Instantiate Result[Unit] for write operations
   package Unit_Result is new
     Hybrid_App_Ada.Domain.Error.Result.Generic_Result (T => Hybrid_App_Ada.Domain.Unit.Unit);
...
end Hybrid_App_Ada.Application.Port.Outbound.Writer;
