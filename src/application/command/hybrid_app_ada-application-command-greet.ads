pragma Ada_2022;
--  =========================================================================
--  Hybrid_App_Ada.Application.Command.Greet - DTO for greet use case
--  =========================================================================
...
--    - Crosses boundary: Hybrid_App_Ada.Presentation -> Hybrid_App_Ada.Application
--
--  Mapping to Go:
...
--
--  See Also:
--    Hybrid_App_Ada.Domain.Value_Object.Person - Hybrid_App_Ada.Domain entity (different from DTO)
--  =========================================================================

with Ada.Strings.Bounded;

package Hybrid_App_Ada.Application.Command.Greet
  with Preelaborate
is

   --  Maximum name length for DTO boundary (larger than domain constraint).
   --  DTO accepts up to 256 chars; Hybrid_App_Ada.Domain validates and rejects > 100 chars.
   --  This intentional boundary isolation:
   --    1. Allows Hybrid_App_Ada.Domain to shrink constraints without breaking Command
   ...
   --  performed in Hybrid_App_Ada.Domain.Value_Object.Person.Create via Result.
...
end Hybrid_App_Ada.Application.Command.Greet;
