...
--
--  Purpose:
--    Unit tests for Hybrid_App_Ada.Domain.Value_Object.Person value object.
--    Tests Create validation and Get_Name accessor.
--    (Greeting format moved to Hybrid_App_Ada.Application layer)
--  ======================================================================
...
begin
   Put_Line ("========================================");
   Put_Line ("Testing: Hybrid_App_Ada.Domain.Value_Object.Person");
   Put_Line ("========================================");
   New_Line;
   ...
   New_Line;
   Put_Line ("========================================");
   Put_Line ("Test Summary: Hybrid_App_Ada.Domain.Value_Object.Person");
   Put_Line ("========================================");
