...
--  Purpose:
--    Unit tests for Hybrid_App_Ada.Domain.Error.Result monad functionality.
--    Tests Ok/Error constructors, Is_Ok/Is_Error queries, and then value
--    extraction.
--  ======================================================================

with Hybrid_App_Ada.Domain;
with Ada.Text_IO;
...
procedure Test_Domain_Error_Result is
   ...
   use Ada.Text_IO;
   use Hybrid_App_Ada.Domain.Error;
   ...
   package Int_Result is new Hybrid_App_Ada.Domain.Error.Result.Generic_Result (T => Integer);

   --  Instantiate Result for Boolean (for testing)
   package Bool_Result is new
     Hybrid_App_Ada.Domain.Error.Result.Generic_Result (T => Boolean);

begin
   Put_Line ("========================================");
   Put_Line ("Testing: Hybrid_App_Ada.Domain.Error.Result");
   Put_Line ("========================================");
   New_Line;
   ...
   New_Line;
   Put_Line ("========================================");
   Put_Line ("Test Summary: Hybrid_App_Ada.Domain.Error.Result");
   Put_Line ("========================================");
