...
--
--  Purpose:
--    Unit tests for Hybrid_App_Ada.Application.Usecase.Greet use case.
...
procedure Test_Application_Usecase_Greet is
   ...
   package Greet_UseCase_Success is new Hybrid_App_Ada.Application.Usecase.Greet
   ...
   package Greet_UseCase_Failure is new Hybrid_App_Ada.Application.Usecase.Greet
     (Writer => Mock_Writer_Failure);

begin
   Put_Line ("========================================");
   Put_Line ("Testing: Hybrid_App_Ada.Application.Usecase.Greet");
   Put_Line ("========================================");
   New_Line;
   ...
   New_Line;
   Put_Line ("========================================");
   Put_Line ("Test Summary: Hybrid_App_Ada.Application.Usecase.Greet");
   Put_Line ("========================================");
