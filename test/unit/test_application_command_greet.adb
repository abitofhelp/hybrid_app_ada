...
--
--  Purpose:
--    Unit tests for Hybrid_App_Ada.Application.Command.Greet DTO.
...
begin
   Put_Line ("========================================");
   Put_Line ("Testing: Hybrid_App_Ada.Application.Command.Greet");
   Put_Line ("========================================");
   New_Line;
   ...
   New_Line;
   Put_Line ("========================================");
   Put_Line ("Test Summary: Hybrid_App_Ada.Application.Command.Greet");
   Put_Line ("========================================");
